...
const toLowerCase = bind.call(Function.call, String.prototype.toLowerCase);
const isProto = bind.call(Function.call, Object.prototype.isPrototypeOf);
...
Test.prototype.comment = function (msg) {
    ...
    String(msg).trim().split('\n').forEach(function (aMsg) {
        that.emit('result', String(aMsg).trim().replace(/^#\s*/, ''));
    });
};
...
Test.prototype['throws'] = function (fn, expected, msg, extra) {
    ...
    try {
        ...
        caught = { error: err };
        if (typeof err == 'object' && err != null && (!isEnumerable(err, 'message') || !has(err, 'message'))) {
