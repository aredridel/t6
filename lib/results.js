...
Results.prototype.run = function () {
    const self = this;
    if (!this._isRunning) {
...
Results.prototype._emitDone = function () {
    this._done = true;
    this._isRunning = false;
    if (!this._doneIsHeld) this.emit('done');
};

Results.prototype._holdDone = function () {
    this._doneIsHeld = true;
};

Results.prototype._releaseDone = function () {
    this._doneIsHeld = false;
    if (this._done) this.emit('done');
};
...
function encodeResult(res, count) {
    ...
    if ('expected' in res || 'actual' in res) {
